...
declare class OutputWithdrawalCoder extends Coder<OutputWithdrawal, OutputWithdrawal> {
    constructor();
...
declare type Output = OutputCoin | OutputContract | OutputWithdrawal | OutputChange | OutputVariable | OutputContractCreated;
...
declare type Receipt = ReceiptCall | ReceiptReturn | ReceiptReturnData | ReceiptPanic | ReceiptRevert | ReceiptLog | ReceiptLogData | ReceiptTransfer | ReceiptTransferOut | ReceiptScriptResult;
