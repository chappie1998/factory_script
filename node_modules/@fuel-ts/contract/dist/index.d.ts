...
import { CallResult, TransactionResponse, TransactionResult, TransactionResultReceipt, ScriptTransactionRequest, CoinQuantity, Provider, CoinQuantityLike, CreateTransactionRequestLike } from '@fuel-ts/providers';
...
declare class Contract implements AbstractContract {
    ...
    constructor(id: string | AbstractAddress, abi: JsonAbi | JsonFlatAbi | Interface, walletOrProvider?: Wallet | Provider | null);
