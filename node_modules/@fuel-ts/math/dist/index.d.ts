...
declare type ToFixedConfig = {
    minPrecision?: number;
    precision?: number;
};
declare type FormatConfig = {
    units?: number;
} & ToFixedConfig;
...
declare const DEFAULT_PRECISION = 3;
declare const DEFAULT_MIN_PRECISION = 1;
declare const DECIMAL_UNITS = 9;
...
export { BN, BNInput, BigNumberish, DECIMAL_UNITS, DEFAULT_MIN_PRECISION, DEFAULT_PRECISION, FormatConfig, ToFixedConfig, bn, format, formatUnits, max, multiply, toBytes, toFixed, toHex, toNumber };
