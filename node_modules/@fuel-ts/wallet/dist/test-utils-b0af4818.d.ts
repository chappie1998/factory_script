import { Provider, TransactionRequestLike, TransactionRequest, CoinQuantityLike, Coin, Message, CoinQuantity, TransactionResponse, CallResult, BuildPredicateOptions, ScriptTransactionRequest, TransactionResult } from '@fuel-ts/providers';
